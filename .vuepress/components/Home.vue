<template>
    <div class='kontener'>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="140 0 3200 1848">
            <path
            ...
            <path id="floor_1_" fill="#090622" d="M0 1592.4h3390v880H0z" />
            <g class="stars">
                <g class="stars">
            ...
            <g id="station2_1_">
                ...
                <path d="M3116.7 941.8s-6.1 3.1-64.6 3.1c-58.6 0-64.5-3.1-64.5-3.1l-20.8-68.7h170.7l-20.8 68.7z"
                    fill="#fecb2f" stroke="#14192e" stroke-width="2" stroke-miterlimit="10" />
                <path class="st7"
                ...
                <path d="M2959 892.4s87.7 16.4 189.3 0" fill="#f8f3dc" stroke="#14192e" stroke-width="2"
            ...
            <!-- <text class="happy" x="1750" y="500" text-anchor="middle">Happy New Year!</text>
            <text class="happy from" x="930" y="700">From Mas Domath</text> -->
            <g id="nave">
                ...
                <path d="M2874.2 470.1s59.6-40 99.6-25.7c0 0 29.3 10.5 12.5 47.5" fill="none" stroke="#f8f3dc"
                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" />
                <circle cx="2953.3" cy="466.3" r="18.4" fill="#f8f3dc" stroke="#13192d" stroke-width="2"
...
.kontener {
    position: relative;
    /* background-color: #1a3142; */
    background: radial-gradient(at top, #000000 20%, #0a043c 100%);
    width: 100vw;
    height: 100vh;
}
...
#nube1 {
    ...
    animation: moveHorizontal 30s 0s linear infinite;
}

#nave2 {
    transform: translateX(-100%) translateY(30%);
    animation: moveHorizontal2 30s 6s linear infinite;
}

#nave3 {
    transform: translateX(-100%) translateY(50%);
    animation: moveHorizontal3 30s 20s linear infinite;
}
...
#sol {
    animation: rotationHalf 50s linear 5;
}
